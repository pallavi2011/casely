        ...
        <Wrapper className="pb-24 pt-10 lg:grid lg grid-cols-3 sm:pb-32 lg:gap-x-0 xl:gap-x-8 lg:pt-24 xl:pt-32 lg:pb-52">
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              <div className="absolute  w-28 left-0 -top-20 hidden md:flex items-center">
                <img src="/logo1.png" className="w-full"/>
                <h1 className="text-green-600 text-6xl">Casely</h1>
              </div>
              ...
              <p className="mt-8 text-lg lg:pr-10 max-w-prose text-center lg:text-left text-balance md:text-wrap">Build your memories by building<span className="font-semibold"> one-of-one </span>phone case.
              Casely allows you to protect your memories, not just your phone case.</p>
          ...
          <div className="col-span-full lg:col-span-1 w-full flex justify-center px-8 sm:px-16 md:px-0 mt-32 lg:mx-0 lg:mt-20 h-fit">
            <div className="relative md:max-w-xl">
              <img src="" className="absolute w-40 lg:w-52 left-56 -top-20 select-none hidden sm:block lg:hidden xl:block"/>
              <Mobile className="w-64 " img='/testimonials/1.jpg'/>
            </div>
          </div>
        </Wrapper>
      </section>
      ...
      <section className="bg-slate-100 py-24">
        <Wrapper className="flex flex-col items-center gap-16 sm:gap-32">
          <div className="flex flex-col lg:flex-row items-center gap-4 sm:gap-6">
            ...
            <img src='/logo1.png' className="w-24 order-0 lg:order-2 bg-slate-50"/>
          </div>
